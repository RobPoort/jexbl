...
--
-- Machine: localhost
-- Genereertijd: 07 jan 2013 om 16:59
-- Serverversie: 5.5.16
-- PHP-Versie: 5.3.8
...
(1, 6, 6, 'diamantsnip normaal', 'diamantsnip normaal tarief midweek', '18-01-2013', '25-01-2013', 5, 650.75, 1, 1, 0, 1),
(2, 4, 5, 'standaardplaats voorjaarsvoordeel', 'sp voorjaars arrangement', '15-03-2013', '31-01-2013', 0, 805.30, 1, 0, 0, 1),
(3, 4, 5, 'Frisse, fruitige lente week', '', '15-04-2013', '21-04-2013', 0, 765.80, 0, 1, 0, 1),
(4, 5, 5, 'hooikiep juni', '', '04-06-2013', '18-06-2013', 0, 500.00, 1, 1, 0, 1);
...
INSERT INTO `localtest_jexbooking_attributes` (`id`, `name`, `desc`, `price`, `is_pn`, `has_price`, `has_number`, `published`) VALUES
(1, 'hond', '1 hond is bij ons toegestaan', 3.00, 1, 1, 1, 1),
(2, 'bijzettent', 'een bijzettent voor bijvoorbeeld uw kinderen', 4.00, 1, 1, 1, 1),
(3, 'avondzon', 'een kampeerplaats met volop zon ''s avonds', 0.00, 1, 0, 0, 1),
(4, 'visplek', 'een kampeerplaats aan de visvijver', 0.00, 1, 0, 0, 1),
(5, 'WiFi', '', 2.75, 1, 1, 0, 1),
(6, 'Koelie', 'Een slaafje voor bij de tent, handig!', 34.00, 1, 1, 0, 1),
(7, 'Geisha', 'Een Geisha voor meneer, voor als mevrouw ook eens rust wil!', 45.90, 1, 1, 0, 1);
