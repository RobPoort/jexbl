...
class JexBookingModelDefault extends JModelAdmin
{
	/**
	...
	*/
	public function getTable($type = 'Defaults', $prefix = 'JexBookingTable', $config = array())
	{
	...
	{
		//get the form
		$form = $this->loadForm('com_jexbooking.default', 'default', array('control'=>'jform', 'load_data'=>$loadData));
		if(empty($form))
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_jexbooking/models/forms/default.js';
	}
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jexbooking.edit.default.data', array());
		if(empty($data))
		{
			$data = $this->getItem();
		}
