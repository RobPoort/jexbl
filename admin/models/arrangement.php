...
class JexBookingModelArrangement extends JModelAdmin
{
	/**
	...
	*/
	public function getTable($type = 'Arrangements', $prefix = 'JexBookingTable', $config = array())
	{
	...
	{
		//get the form
		$form = $this->loadForm('com_jexbooking.arrangement', 'arrangement', array('control'=>'jform', 'load_data'=>$loadData));
		if(empty($form))
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_jexbooking/models/forms/arrangement.js';
	}
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jexbooking.edit.arrangement.data', array());
		if(empty($data))
		{
			$data = $this->getItem();
		}
